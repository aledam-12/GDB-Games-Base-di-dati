function updateQuantity(i, change, Titolo, Prezzo, Piattaforma) {
    ...
    var url = "./controlloCarrello?action=add&titolo=" + encodeURIComponent(Titolo) + "&prezzo=" + encodeURIComponent(Prezzo) + "&console=" + encodeURIComponent(Piattaforma) + "&quantita=" + encodeURIComponent(newQuantity);
